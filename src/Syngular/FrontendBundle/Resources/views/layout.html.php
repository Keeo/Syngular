...
<html>
	<head>
		...
		<script src="<?php echo $view['assets']->getUrl('bundles/syngular/lib/jquery/dist/jquery.min.js') ?>"></script>
		...
		<script src="<?php echo $view['assets']->getUrl('bundles/syngular/lib/bootstrapValidator/dist/js/bootstrapValidator.min.js') ?>"></script>
		...
		<link rel="stylesheet" href="<?php echo $view['assets']->getUrl('bundles/syngular/lib/bootstrapValidator/dist/css/bootstrapValidator.min.css') ?>">
